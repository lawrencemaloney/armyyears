    ...
    <>
      <div className='  mt-[40px] mx-auto  flex flex-col items-center '>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          for volunteers for the Marine Corps. Not getting as many as he needed, he
          "volunteered" a couple. The rest of us were loaded onto a bus and driven about 80
          miles to Fort Dix.
        </p>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          hard. Keep in mind, about 25% of the trainees were draftees and had not chosen to be
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          this required a very limited set of skills. But they also needed junior officers to
          fill the ranks of those that were leaving the Amy and could not be adequately filled
          by commissioning programs like military academies. To fill the gap, the U.S. Army
          instituted Officer Candidate School (OCS). “OCS is a 12-week course designed to
          train, assess, evaluate, and develop second lieutenants for the U.S. Army. It is the
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          additional training. I would begin OCS After basic and advanced infantry training
          when I would be assigned to an OCS that specialized in whatever skills the Army
          thought most useful. Since it would delay a possible assignment to Vietnam by a
          couple of months and I would make a few more dollars each month, I signed up. The
          ramifications of this decision would not be known until I was more than half-way
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch] '>
          ...
          Training was to get us in “fighting shape”.
        </p>
        ...
        <div className=' max-w-[45ch] mt-4 md:max-w-[75ch]'>
          ...
          />
          <span className='text-sm leading-none '>
            (U.S. Army Pistol Training - National Archives and Records Administration)
          </span>
        </div>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          the M1 and then the M16 before graduation. We also had to qualify with the .45 Cal
          pistol (official designation: Pistol, Caliber .45, Automatic, M1911A1). A very
          awkward and inaccurate weapon, at least in my hands.
        </p>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]'>
          ...
          beds lined up on either side of a central aisle. I was assigned to a mortar platoon
          for specialized training in the 81mm and M30 (4.2-inch) mortars. To use these
          weapons, you had to be pretty close to the enemy. The effective range of both mortars
          was about 3 miles. Although 3 miles may seem like a long way, someone, a forward
          observer (FO), had to be close enough to see the enemy, radio back to the men
          servicing the weapon, and call in rounds. Calling in rounds required the FO to
          estimate distance and direction for the first round, extrapolate from where the round
          landed what adjustments need to be made for the second round. Watch that round,
          adjust again, etc.
        </p>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch] '>
          ...
          fighting in Vietnam, we were also taught skills that would be of particular value in
          jungle fighting, like recognizing booby traps and potential ambushes. We played “war
          games” that attempted to simulate what it might be like on patrol in Vietnam.
        </p>
        <div className='max-w-[45ch] mt-4 md:max-w-[75ch]'>
          <img
            className=' border-2 border-black '
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]'>
          ...
          hear) the bullets flying overhead. While the exercise was spectacular, it was also a
          little scary, even though If you looked down the line instead of straight up, you
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]'>
          ...
          still couldn’t get the three basic steps right when it came to live fire. The
          live-fire grenade range consisted of a long row of small bunkers each about 6 foot by
          12 foot, surrounded on three sides with sandbags and reinforced with telephone pole
          sized logs. Each trainee would go inside the bunker with a drill sergeant. Over and
          over we practiced: 1- remove the pin, 2- throw the grenade as far as you can, 3 –
          duck below the front wall.
        </p>
        <div className='max-w-[45ch] mt-4 md:max-w-[75ch]'>
          <img
            className='border-2 border-black '
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          happy! Apparently, the trainee panicked and got the order wrong. He pulled the pin,
          ducked, and then threw the grenade (1,3,2), which hit the front wall of the bunker.
          The trainee flew out of the bunker having been thrown out by the DI (a very strong
          man). Luckily, the Army is somewhat prepared for this level of incompetence. Each
          bunker had a deep trough angled so that grenades that didn’t make it out of the
          bunker over the top would (hopefully) role down the trough into a special
          compartment. No one was hurt, except maybe the trainee when he landed. But it
          solidified in my mind that war is dangerous and some people should not be allowed to
          fight in them.
        </p>
        <h3 className=' text-center  underline text-2xl mt-4 mb-3'>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          (KP). I was fortunate in that the chief cook in our company was a very reasonable
          person and a great cook. He had been the cook at the base commander’s previous post
          and developed a reputation as being one of the best cooks in the Army. When the
          commander moved to Ft. Lewis, the cook came with him. One of the things that I
          learned during this time was that officers ate a lot better than regular troops. I
          also learned how to peel potatoes fast. I took it as a challenge to peel as many as I
          could in the time allotted. I figured that since I had to peel them I might as well
          be the best at it. It turns out that this attitude was unusual in the Army and the
          cook took a liking to me. Although I didn’t sit with the officers, I was allowed to
          eat what they were having before helping to serve the troops.
        </p>
        <h3 className=' text-center  underline text-2xl mt-4 mb-3'>Providence of God</h3>
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          few had any expectation of any assignment other than Vietnam. It was more a question
          of at what base in Vietnam we would be stationed. I was the only one of this group
          (and one of only three men in the 300+ man training company) who knew what their
          orders would be for assignments outside of Vietnam.
        </p>
        <div className=' max-w-[45ch] mt-4 md:max-w-[75ch]'>
          <img
            className='border-2 border-black '
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          came in and introduced himself and explained why we there. He said that the war in
          Vietnam was winding down and that the Army was looking to close most of the Officer
          Candidate Schools to cut the cost of the war. The Army believed that it had more than
          enough officers. The issue for the Army was that the documents we (the soldiers)
          signed to be able to attend OCS also obligated the Army to honor their side of the
          contract. Unless both sides agreed to change the terms the Army had to send us to
          OCS. To encourage us to sign a waiver, the Army offered two enticements: the first
          was that we would revert to a 2-year active duty commitment and the second was that
          we would be guaranteed a choice of duty station at an Army base anywhere in the world
        ...
        <p className='text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
          ...
          active duty time left to be sent to a combat zone. To be certain, I asked the Major
          if that meant we would not be assigned to Vietnam and he said: “That is correct”. He
          told us that we had a week to decide. I did not need two minutes to decide. I was
          ready to sign. On the waiver form, we had to list three desired duty station
          locations in order of preference. Since I had always wanted to travel to Europe, I
          listed England, Germany, and the U.S. in that order. Reviewing the form, the Major
        ...
        <p className=' mb-[8rem] text-[20px] mx-[20px] mt-[1rem] max-w-[38ch] sm:text-[25px] sm:max-w-[40ch] leading-[32px]  lg:max-w-[60ch]  '>
