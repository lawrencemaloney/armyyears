...
function Archives() {
  return (
    ...
    <div className="archivewrap z-20  mt-0   h-[100%] max-w-full items-center ">
        <div className="texcontainer grid place-items-center min-h-screen">
       ...
       grid grid-cols-1 max-w-5xL mx-4  tablet:gap-4  mobile:grid-cols-3 tablet:grid-cols-4 ">
        ...
        {PDFRef.map((issue) => (
              ...
              <a href={issue.href_url}> 
                ...
                <img
                  className="image  border border-2 border-black    rounded  object-top object-cover  aspect-square"
                  src={issue.page1_url}
                  alt={issue.caption}
                />
