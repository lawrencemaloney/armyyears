...
function MyPhotos() {
	...
	<>
		...
		<div className='App bg-black w-[100vw]  text-white '>
			...
			<div className="pageContainer grid  grid-cols-2   auto-rows-max	 gap-4 w-[100vw]	
			sm:grid-cols-4  ">

				<div className="subhead z-[21] sticky w-screen bg-black h-[140px] top-0">
					<h1 className='  mt-[2rem] mb-[10px] text-center text-3xl  
					sm:text-4xl w-[100vw]   md:fixed md:top-[30px]'>My Photos</h1>

					<h2 className=' text-2xl col-start-1 col-span-12 text-center sm:hidden'>{group}</h2>
					{!isOpen ?
					(
				...
				sm:ml-[4px] sm:h-[650px] sm:w-[150px]  sm:top-[180px] sm:left-0 md:ml-[50px]  sm:text-[20px]
					...
					<ul className='  h-[100%] w-[100px] flex-col mt-4   bg-black text-left rounded-lg text-white   text-[14px]  space-y-[10px] '>
				...
				<div className="textcontainer mt-[2rem] w-[100vw] mx-2  text-[20px] leading-[32px] col-start-1 col-span-2 row-start-2  h-[25%]
				sm:min-w-[65ch] sm: sm:text-[25px] sm:max-w-[20ch] sm:p-[20px] sm:col-start-2  sm:col-span-5  sm:row-start-2  
				md:mx-auto
				lg:max-w-[28ch]      ">
					...
					<div className="imgcontainer ml-[20px] grid grid-cols-2 col-start-1 col-span-2 row-start-4  sm:grid-cols-3 sm:col-start-2  sm:col-span-6        md:col-start-2  md:col-span-6   lg:grid-cols-4  lg:col-start-2  lg:col-span-4   ">
