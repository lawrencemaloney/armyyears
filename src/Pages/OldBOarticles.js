...
function OldBOarticles() {
  return (
    <>
      <Header />
      <Sidebar />
      <div className="articlewrap z-20 mx-auto  h-[100%] grid grid-cols-1 justify-items-center tablet:grid-cols-4 ">
        <div className="articletext  mx-auto grid grid-cols-1  ">
          ...
          (Click Image to Read)
            ...
            <p className=" mx-[20px] mt-[1rem] max-w-[38ch] text-[20px] leading-[32px] mobile:max-w-[40ch] mobile:text-[25px]  laptop:max-w-[60ch] ">
                ...
                were preserved on the website: <a ClassName="bolink"  href="http://www.theberlinobserver.com" target="_blank" rel="noopener noreferrer" >Berlin Observer.com.</a> <span ClassName= "newtab"> (Opens in a new tab.) </span> 
            </p>
            <p className=" mx-[20px] mt-[1rem] max-w-[38ch] text-[20px] leading-[32px] mobile:max-w-[40ch] mobile:text-[25px]  laptop:max-w-[60ch] ">
        ...
        <div className="articles w-[80vw] mt-[40px] grid grid-cols-1 gap-4	 mobile:grid-cols-3 tablet:grid-cols-3 gap-8">
          
        <article ClassName="bobsrvrjuly1770 	 ">
            <h5 >July 17, 1970</h5>

            <Link className="mx-[20px]  my-10 text-[20px] leading-[32px] h-[100%] w-[85%] mobile:max-w-[35ch] mobile:text-[25px]  laptop:max-w-[60ch] outline outline-black "  to= "/BOarticle1770"><img className=" border border-2 border-black w-full rounded-md"  src="..\media\BO page1 images\Berlin Observer archive1970\Berlin Obsever V26_N28_jul17 1970.jpg" alt="Berlin Observer July 17 1970"
                    width="211px" height="139px" /> </Link>

        </article>  
        
        <article ClassName="bobsrvrdec1170 ">
        ...
        <article ClassName="bobsrvrfeb0571">
        ...
        <article ClassName="bobsrvrfeb121">
        ...
        <article ClassName="bobsrvrfeb191">
        ...
        <article ClassName="bobsrvrmar571">
            <h5>March 5, 1971</h5>
        ...
        <article ClassName="bobsrvrmay571">
            <h5>May 7, 1971</h5>
        ...
        <article ClassName="bobsrvrmay1471">
            <h5>May 14, 1971</h5>
        ...
        <article ClassName="bobsrvrmay2171">
            <h5>May 21, 1971</h5>
        ...
        <article ClassName="bobsrvrmay2871">
            <h5>May 28, 1971</h5>
        ...
        <article ClassName="bobsrvrjune2571">
            <h5>June 25, 1971</h5>
        ...
        <article ClassName="bobsrvrjul0271">
            <h5>July 2, 1971</h5>
        ...
        <article ClassName="bobsrvrjuly0971">
            <h5>July 09, 1971</h5>
        ...
        <article ClassName="bobsrvrjul1671">
            <h5>July 16, 1971</h5>
        ...
        <article ClassName="bobsrvrjul3071">
            <h5>July 30, 1971</h5>

            <Link className="mx-[20px]  my-10 text-[20px] leading-[32px] h-[100%] w-[85%] mobile:max-w-[35ch] mobile:text-[25px]  laptop:max-w-[60ch] outline outline-black " to= "/BOarticle073071"><img className=" border border-2 border-black w-full rounded-md"  src="..\media\BO page1 images\All Page1 Images\Berlin Obsever V27_N30_jul30 1971.jpg" alt="Berlin Observer July 17 1970"
                    width="211px" height="139px" /> </Link>             

        </article>

        <article ClassName="bobsrvraug2071">
        ...
        <article ClassName="bobsrvraug2771">
        ...
        <article ClassName="bobsrvrsep2471">
        ...
        <article ClassName="bobsrvroct1571">
        ...
        <article ClassName="bobsrvrnov0571">
        ...
        <article ClassName="bobsrvrnov2671">
        ...
        <article ClassName="bobsrvrdec0371">
        ...
        <article ClassName="bobsrvrdec1071">
        ...
        <article ClassName="bobsrvrdec1771">
        ...
        <article ClassName="bobsrvrdec2371">
      ...
      <div>
        ...
        <a ClassName="bofulleddition" href="..\BO_PDFs\B O Jul 17 1970.pdf">
        <button >
            <span ClassName="fulledtext">
            <p>Full Eddition</p>
            </span>
        </button>
    </a>
