...
function MenuItems({showHideMenu, active}) {
  return (
    <>
        ...
        <ul className={active ?'fixed z-20 	left-[50%] transform -translate-x-[50%]  duration-500 ease-in w-[18ch] h-[22rem] flex-col  bg-zinc-700/90 text-center	rounded  text-[28px] 	lg:hidden ' : ' transform translate-x-[50%]  duration-500 ease-in text-[28px] w-[18ch] absolute left-[100%] text-center' }>
