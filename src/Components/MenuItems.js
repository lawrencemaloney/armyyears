...
function MenuItems({showHideMenu, active}) {
  return (
    <>
        ...
        <ul className={active ?'fixed z-20 	left-[50%] transform -translate-x-[50%]  duration-500 ease-in w-[18ch] h-[20rem] flex-col  bg-zinc-700/90 text-center	rounded  text-[28px] 	lg:hidden ' : ' origin-right	 text-[32px] absolute left-[100%]' }>
