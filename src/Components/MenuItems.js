...
function MenuItems({showHideMenu, active}) {
  return (
    <>
        ...
        <ul className={active ?' h-[100dvh] w-[100%] flex-col absolute top-450 left-0 bg-[#e8e4d5] text-center  border border-black	rounded-lg text-black text-[28px] lg:hidden  ' : ' hidden ' }>
