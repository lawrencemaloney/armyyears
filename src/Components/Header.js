...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className=' top-0 left-0 right-0 m-0 h-[160px] w-[100vw] md:ml-[2vw] bg-amber-50  justify-center   sm:ml-[1vw] z-[100]  sm:h-[166px] lg:space-x-36 flex text-center'>
    ...
    <div className="    sm:hidden top-[170px] sm:right-16 sm:top-12  py-4 cursor-pointer border-black border-b ">

    <AiOutlineMenu className=" sticky left-[50%]  -translate-x-1/2 top-[35px] h-[32px] w-[32px] ring-offset-2 ring-2	 z-[1000]  bg-white"  onClick={showHideMenu}>
    </AiOutlineMenu>
